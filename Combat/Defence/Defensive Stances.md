...
- **[[Parry]]** — deflecting **one** incoming [[Attacks|attack]] using precise weapon technique
- **[[Dodge]]** — avoiding [[Attacks]] through [[Movement Types|movement]] and repositioning
## Stance Priority
...
| Your [[Parry]] fails due to **failed Grace Test**             | You take [[Damage Types\|damage]] → **all defensive stances end** for the remainder of the [[Rounds\|round]]          |
