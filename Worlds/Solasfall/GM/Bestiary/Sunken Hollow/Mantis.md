...
Standing roughly human height — taller when reared — but unnervingly narrow and elongated, the mantis is built entirely wrong for its size. Its long limbed and unnervingly still until it isn't, chitin shifting in slow, restless patterns even at rest, never quite settling on a single colour, never quite invisible. In poor light it dissolves into the cave's shifting bioluminescence almost entirely. Provoked, frightened, or seeking a mate, that shifting can erupt into a violent cascade of colour that seems to come from nowhere.

Found stalking the margins of [[The Sunken Hollow]]'s larger chambers, preying on whatever strays too close while it waits in stillness.
...
| Climb | 5          | 1.5m per [[Ticks, Priority & Resolution\|Tick]] |
...
## Ecosystem Notes
See [[The Sunken Hollow]] for the full ecosystem relationships. The mantis preys opportunistically on [[Ant Worker|ants]] and [[Cockroach|cockroaches]], and is itself prey to the [[Tarantula]] should the opportunity arise.
