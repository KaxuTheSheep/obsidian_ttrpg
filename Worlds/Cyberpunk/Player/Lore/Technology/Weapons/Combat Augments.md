---
tags: [technology, augments, combat, weapons]
---

# Combat Augments

*Four augments. Four distance bands. One coherent identity — control first, kill second.*
...
**Distance band:** zero — requires grip and positional control
...
**Distance band:** touch — contact range, stationary or near-stationary

**Mechanism:** a single blade housed in the metacarpal space between the middle and ring finger, deploying from between those fingers on the back of the hand. The push knife grip — driving force directly through the blade without wrist rotation — is one of the most biomechanically efficient blade configurations. This augment internalises that grip permanently.
...
**Visible characteristics:** nearly invisible in normal configuration. The blade itself does not protrude until deployed. Deployment motion is a slight hand closure. No dramatic transformation.

**Power draw:** minimal — the deployment mechanism is simple and the blade itself is passive.

---

### Claw and Venom System

**Distance band:** surface contact — raking range

**Mechanism:** two integrated components operating as one system.

The claw extends the fingertips into curved cutting edges — not replacing the fingers but extending from them, the fingernail position becoming the attachment point for ceramic or graphene composite claw elements. The attack motion is a rake across the target's surface rather than a puncture or a closure. Multiple simultaneous contact points across a wider area than the push knife.

The venom system stores a synthesised compound in reservoirs distributed through the palm's fatty tissue — the thenar and hypothenar spaces provide sufficient volume without compromising hand structure. The claw's surface contact breaks the target's skin and deposits the compound. The wound does not need to be deep. It needs to break the surface and deliver the payload.
...
**Supply chain:** the compound comes from somewhere — conglomerate pharmaceutical subsidiary, black market with provenance uncertainty, or a faction with sufficient biotech capability to produce it internally. Ongoing dependency on that supply chain. The refill requirement is a faction entanglement as much as a maintenance requirement.

**Visible characteristics:** extended claws are visible and clearly weaponised. In retracted state the fingertips look slightly unusual but not obviously dangerous. The refill port is visible on the wrist or palm — identifiable to anyone who knows what it indicates.

**Power draw:** low for claw deployment and retraction, moderate if the compound delivery mechanism is actively pressurised.

---

### Compressed Flechette

**Distance band:** short to medium — approximately fifteen to twenty metres effective range

**Mechanism:** a compressed gas system housed in the forearm, sharing the venom compound reservoir and refill port with the claw system above. A small needle or flechette projectile propelled by compressed gas release, firing from a port near the wrist or heel of the palm when the arm is extended forward.

**Shared resource:** the flechette and claw systems use the same compound. Loading a specific compound serves both delivery modes simultaneously. The refill port replenishes both. This is not two augments — it is one system with two delivery modes for the same payload.

**Why not a blowdart:** a breath-powered delivery requires a tube to the mouth, an anatomically awkward interface and an immediately readable tell. Compressed gas internal to the forearm removes the mouth interface entirely. The firing motion is extending the arm — no additional tell beyond the arm position.

**Sound profile:** near-silent. Compressed gas release rather than combustion. The flechette is too small and slow for a significant sonic crack. In a loud environment essentially inaudible. No muzzle flash, no ejected case, the projectile nearly invisible in flight.
...
| Compressed Flechette | 15-20m | Ranged compound delivery | Very Low | Minimal per shot |
...
Combat augments at this level are not off-the-shelf purchases. They require:

- Faction alignment that provides access to a fitter capable of the installation
- Sufficient reputation or trust to be offered hardware this significant
- Financial investment or faction obligation in exchange

The scissor arm specifically — the most structurally significant of the four — requires full forearm replacement below the elbow. This is a major installation, not an add-on. The decision to install it is not casual.

---

*See [[Weapons Technology]], [[Slot Categories]], [[Pairing Protocol & Network Security]], [[Game/Systems/NPCs/Fitters]].*
